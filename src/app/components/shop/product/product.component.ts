...
export class ProductComponent implements OnInit {
  ...
  getproduit(){
    ...
    addProductToCart(product: product): void {
      this.produitservice.addProductToCart(product).subscribe(
        () => {
